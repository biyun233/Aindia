...
class Candidat extends Component {
  constructor(props) {
    super(props);
    this.OfferDetails = Firebase.firestore()
  ...
  _renderItem = ({ item, index }) => {
    return (
      <TouchableOpacity
        onPress={() => this.props.navigation.navigate("OffreDetails", item)}
      >
        <Card item={item} />
      </TouchableOpacity>
    );
        ...
        >
          <View style={styles.row}>
            ...
            <Button
              ...
              titleStyle={styles.filtrer}
              onPress={() => {
                this.props.navigation.navigate("Filtrer", {
                  refresh: () => {
                    this._refresh();
                  },
                });
