        ...
        <KeyboardAwareScrollView>
          <View style={styles.content}>
            <TextInput
              ...
              onChangeText={(value) => this.inputValueUpdate(value, "title")}
            />
            <TextInput
              style={styles.input}
              placeholder="Nom d'entreprise"
              value={this.state.nom}
              onChangeText={(value) => this.inputValueUpdate(value, "nom")}
            />
            <TextInput
              style={styles.input}
            ...
            <TextInput
              ...
              onChangeText={(value) => this.inputValueUpdate(value, "mission")}
            />
            ...
            <TextInput
              ...
              onChangeText={(value) => this.inputValueUpdate(value, "techs")}
            />
            <Button
              title="valider"
